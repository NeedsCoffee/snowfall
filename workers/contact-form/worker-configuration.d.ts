/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 41898945099dd86f503e823430d3b0ad)
...
declare namespace Cloudflare {
	...
	interface Env {
		EMAIL: SendEmail;
		ALLOWED_ORIGINS: "https://robinbayliss.com,https://www.robinbayliss.com,https://api.robinbayliss.com";
		CONTACT_FROM_NAME: "Robin Bayliss Website";
		SUCCESS_URL: "https://robinbayliss.com/contact-thanks/";
		TURNSTILE_EXPECTED_ACTION: "contact";
		TURNSTILE_EXPECTED_HOSTNAME: "robinbayliss.com";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "CONTACT_FROM_NAME" | "SUCCESS_URL" | "TURNSTILE_EXPECTED_ACTION" | "TURNSTILE_EXPECTED_HOSTNAME" | "CONTACT_FROM_EMAIL" | "CONTACT_TO_EMAIL" | "SECRET_KEY" | "SITE_KEY">> {}
}
